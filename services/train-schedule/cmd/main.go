...
import (
	...
	"github.com/mioyisama/railway/services/train-schedule/internal/server"
)

func main() {
	cfg := config.Load("train-schedule")
	...
	srv := grpcserver.New()
	pb.RegisterTrainScheduleServiceServer(srv, server.New())
