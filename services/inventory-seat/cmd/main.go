...
import (
	...
	"github.com/mioyisama/railway/services/inventory-seat/internal/server"
)

func main() {
	cfg := config.Load("inventory-seat")
	...
	srv := grpcserver.New()
	pb.RegisterInventorySeatServiceServer(srv, server.New())
